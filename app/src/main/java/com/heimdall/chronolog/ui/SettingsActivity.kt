...
print(default_api.read_file(path='app/src/main/java/com/heimdall/chronolog/ui/SettingsActivity.kt'))
print(default_api.read_file(path='app/src/main/java/com/heimdall/chronolog/google/GoogleDriveBackupManager.kt'))
print(default_api.read_file(path='app/src/main/AndroidManifest.xml'))
